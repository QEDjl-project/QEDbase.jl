...
allowed_muls = Dict([(AdjointBiSpinor,BiSpinor)=>ComplexF64,
...
@testset "DiracTensor" begin
    ...
    dirac_tensors = [BiSpinor(rand(ComplexF64,4)),AdjointBiSpinor(rand(ComplexF64,4)),DiracMatrix(rand(ComplexF64,4,4))]
    ...
    @testset "BiSpinor" begin
        ...
        @test_throws DimensionMismatch("No precise constructor for BiSpinor found. Length of input was 2.") BiSpinor(1,2)
    end #BiSpinor
    ...
    @testset "AdjointBiSpinor" begin
        ...
        @test @inferred(AdjointBiSpinor(1,2,3,4))==@inferred(AdjointBiSpinor([1,2,3,4]))
        ...
        @test_throws DimensionMismatch("No precise constructor for AdjointBiSpinor found. Length of input was 2.") AdjointBiSpinor(1,2)
    ...
    @testset "DiracMatrix" begin
        ...
        @test_throws DimensionMismatch("No precise constructor for DiracMatrix found. Length of input was 2.") DiracMatrix(1,2)
