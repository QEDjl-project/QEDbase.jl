...
!!! note
    The correct return type can't be inferred from input types here because `AbstractProcessDefinition`s are agnostic to the
    four-momenta types used with them. Therefore, a parameter is necessary.
"""
